...
Project owners are [sseworld](https://github.com/sseworld) and this is coppied form [JMPerez](https://github.com/JMPerez)
...
## Installation
```bash
$ npm install sse-spotify-api --save
```
...
```javascript
var SpotifyWebApi = require('sse-spotify-api');
...
Retrieving a track's metadata in `sse-spotify-api` version 1.4.0 and later:
...
See something you think can be improved? [Open an issue](https://github.com/sseworld/sse-spotify-api/issues/new) or clone the project and send a pull request with your changes.
