...
@sseworld/detector is a precise user agent parser and device detector written in TypeScript, backed by the largest and most up-to-date open-source user agent database.

@sseworld/detector will parse any user agent and detect the browser, operating system, device used (desktop, tablet, mobile, tv, cars, console, etc.), brand and model. Works with Node.js and in the browser.
...
<!-- [![Coveralls github](https://img.shields.io/coveralls/github/etienne-martin/@sseworld/detector.svg)](https://coveralls.io/github/etienne-martin/@sseworld/detector) -->
<!-- [![CircleCI build](https://img.shields.io/circleci/project/github/RedSparr0w/node-csgo-parser.svg)](https://circleci.com/gh/etienne-martin/@sseworld/detector) -->
<!-- [![node version](https://img.shields.io/node/v/@sseworld/detector.svg)](https://www.npmjs.com/package/@sseworld/detector)
[![npm version](https://img.shields.io/npm/v/@sseworld/detector.svg)](https://www.npmjs.com/package/@sseworld/detector)
[![npm monthly downloads](https://img.shields.io/npm/dm/@sseworld/detector.svg)](https://www.npmjs.com/package/@sseworld/detector) -->
...
To use @sseworld/detector in your project, run:

```bash
npm install @sseworld/detector
```
...
```javascript
import DeviceDetector from "@sseworld/detector";
```

##### TypeScript import:

```typescript
import DeviceDetector = require("@sseworld/detector");
```
...
```javascript
import BotDetector from "@sseworld/detector/dist/parsers/bot";
...
## What @sseworld/detector is able to detect
