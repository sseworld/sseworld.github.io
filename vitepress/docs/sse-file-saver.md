...
Syntax
------
### Import `saveAs()` from sse-file-saver
```js
import { saveAs } from 'sse-file-saver';
```
...
```js
var FileSaver = require('sse-file-saver');
...
npm install sse-file-saver --save
bower install sse-file-saver
```
...
npm install @types/sse-file-saver --save-dev
```
